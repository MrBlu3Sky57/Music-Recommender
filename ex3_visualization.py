...
def visualize_graph(graph: ex3_part2.Graph,
...
def visualize_graph_clusters(graph: ex3_part2.Graph, clusters: list[set],
                             layout: str = 'spring_layout',
                             max_vertices: int = 5000,
                             output_file: str = '') -> None:
...
visualize_graph(ex3_part2.load_review_graph("data/reviews_medium.csv", "data/book_names.csv"))
