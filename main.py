...
if __name__ == '__main__':
    ...
    while True:
        ...
        name = input()
        print('What is the name of the artist who made this song?')
        artist = input()
    ...
    print("Here is how your song looks in relations to other popular songs")
    ...
    print("Here is a visualization of the songs within the same community as your song, with coloured by similarity, with lighter colouring meaning more similar:")
    com = partition[song]
    ...
    print('Here are some recommendations for you based on your song choice')
